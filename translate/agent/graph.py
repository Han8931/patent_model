...
def build_graph():
    ...
    Claims-first ordering: the bulk claim translator returns a Korean→English
    glossary that seeds terminology for the description, so antecedent basis
    in the body lines up with how the claims actually named the elements.
