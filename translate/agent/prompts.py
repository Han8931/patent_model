...
_COMBINED_LEGEND_INSTRUCTION = (
    ...
    "- Required output shape (one parameter per clause, joined by ';'):\n"
    "    [EQUATION_1], where <s1> is <meaning_1>; <s2> is <meaning_2>;\n"
    "    [EQUATION_2], where <s3> is <meaning_3>; <s4> is <meaning_4>;\n"
    "    [EQUATION_3], where <s5> is <meaning_5>; <s6> is <meaning_6>.\n"
    ...
    "\n"
    "PER-PARAMETER CLAUSES — CRITICAL:\n"
    "- Each parameter MUST get its own clause. Format: '<symbol> is <meaning>'\n"
    "  (or '<symbol> denotes <meaning>'), with clauses separated by ';'.\n"
    "- DO NOT collapse parameters into 'respectively' form or comma-list form.\n"
    ...
    "  in order), STILL expand it into per-parameter clauses in English.\n"
    "- The number of output clauses MUST equal the number of '<symbol>는/은'\n"
    "  items in the source. Do not merge or drop any.\n"
)
