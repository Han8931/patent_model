...
_BRACKET_RULES = (
    ...
    "   - If parentheses contain a short alphanumeric reference character with at least one digit,\n"
    "     remove the parentheses and keep the reference character after the noun phrase.\n"
    "     Examples: '전극(100a)' → 'an electrode 100a', '단계(S10)' → 'step S10'.\n"
    "   - Do NOT remove parentheses around abbreviations/acronyms with no digits, units, or\n"
    "     explanatory English names. Keep as-is: (CPO), (AI), (MSB), (LSB), (J), (W),\n"
    "     (Optic Engine Unit: OEU), (see FIG. 1).\n"
    "   - Mixed symbol forms that are themselves reference characters or variables, such as\n"
    "     GR(1), T1, BIT_3k, θ_k, and 〖BIT〗_(3k+1), must be preserved exactly.\n"
...
_REVIEW_SYSTEM = (
    ...
    "5. Reference numerals and characters — all reference numerals/symbols from the Korean\n"
