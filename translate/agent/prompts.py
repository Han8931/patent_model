...
_BRACKET_RULES = (
    ...
    "     the output.\n"
    "   - Do NOT remove parentheses around abbreviations/acronyms with no digits,\n"
    "     units, or explanatory English names. Keep as-is: (CPO), (AI), (MSB),\n"
    "     (LSB), (J), (W), (MD), (EMC), (NF), (GR), (Optic Engine Unit: OEU),\n"
    "     (see FIG. 1). An abbreviation has only letters (or letters plus a colon\n"
    "     gloss); a reference character has at least one digit.\n"
